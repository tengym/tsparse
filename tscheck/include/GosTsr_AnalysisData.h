...
typedef void (*AnalysisData_FUN)(GOSTSR_U8 chanID,TS_SECTION_INFO *tsSectionInfo);
...
extern GOSTSR_S32 GosTsr_AnalysisData_TsEnvReInit(GOSTSR_U8 chanID);
...
extern GOSTSR_S32 GosTsr_AnalysisData_CallBack(GOSTSR_U8 chanID,TS_SECTION_INFO *tsSectionInfo);
extern GOSTSR_S32 GosTsr_AnalysisData_PacketType(GOSTSR_U32 *pu32PacketLen, GOSTSR_U32 u32DatatLen,GOSTSR_U8 *pData);
...
extern GOSTSR_S32 GosTsr_AnalysisData_PAT_Free(GOSTSR_PSISI_PAT_S *patInfo);
extern GOSTSR_S32 GosTsr_AnalysisData_CAT_Free(GOSTSR_PSISI_CAT_S *catInfo);
extern GOSTSR_S32 GosTsr_AnalysisData_PMT_Free(GOSTSR_PSISI_PMT_S *pmtInfo);
extern GOSTSR_S32 GosTsr_AnalysisData_getServiceName(char *servicename, GOSTSR_U16 *serviceID, TS_SECTION_INFO *pSectionInfo);
